...
# responseObject = create_iam_user("TatvaSimpleTest1")
...
# update_iam_user("TatvaSimpleTest1", "TatvaSimpleupdated")
# list_iam_users()
...
# delete_iam_user("TatvaSimpleupdated")
# list_iam_users()
...
# create_iam_user("policy_attahc_user")
# attach_custom_iam_policy_with_user("test_policy_1_by_sandip", "policy_attahc_user")
...
# attach_managed_iam_policy_with_user("AdministratorAccess", "policy_attahc_user")
...
# detach_custom_iam_policy_with_user("test_policy_1_by_sandip", "policy_attahc_user")
...
# detach_managed_iam_policy_with_user("AdministratorAccess", "policy_attahc_user")
...
def create_role(role_name, trust_document):
    try:
        ...
        iam_client.create_role(
            RoleName=role_name, AssumeRolePolicyDocument=json.dumps(trust_document)
        )
    except ClientError as e:
        if e.response["Error"]["Code"] == "EntityAlreadyExists":
            print("Object already exists")
